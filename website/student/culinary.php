...
<head>
    ...
    <style>
        ...
        body::before {
            ...
            width: 100%;
            height: 100%;
            background-image: url('ads32/culinaryy.png');
        ...
        .header h1 {
            ...
            padding: 14px 28px;
            border-radius: 20px;
            background: linear-gradient(135deg, rgba(139, 69, 19, 0.88) 0%, rgba(184, 115, 51, 0.76) 100%);
            border: 1px solid rgba(255, 255, 255, 0.24);
            box-shadow: 0 14px 32px rgba(83, 47, 20, 0.22);
