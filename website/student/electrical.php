...
<head>
    ...
    <style>
        :root {
            ...
            --electrical-bg-image: url('ads36/background electrical.png');
        }
        ...
        body::before {
            ...
            inset: 0;
            background:
                linear-gradient(rgba(10, 31, 77, 0.74), rgba(10, 31, 77, 0.74)),
                var(--electrical-bg-image) center center / cover no-repeat;
            z-index: -1;
        }
        ...
        .header h1 {
            ...
            padding: 14px 28px;
            border-radius: 20px;
            background: linear-gradient(135deg, rgba(255, 99, 71, 0.88) 0%, rgba(255, 140, 105, 0.76) 100%);
            border: 1px solid rgba(255, 255, 255, 0.24);
            box-shadow: 0 14px 32px rgba(120, 52, 38, 0.22);
...
<body>
    <div class="container">
        ...
        <div class="course-grid">
            ...
            $products = [
                [
                    'type' => 'BAJU ELECTRICAL',
                    'price' => 'RM85.00',
                    'image' => 'ads46/BAJU ELECTRICAL.png'
                ],
                [
