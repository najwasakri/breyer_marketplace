...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if ($admin && password_verify($password, $admin['password_hash'])) {
            ...
            $_SESSION['admin_nama'] = $admin['full_name']; // atau ikut nama field dalam DB anda
            $_SESSION['admin_ic'] = $ic_number;     // contoh: no kad pengenalan
            // $_SESSION['admin_password'] = $password; // (jika mahu, tapi TIDAK DIGALAKKAN simpan password plaintext)
