    ...
    <style>
        ...
        * {
        ...
        @media (max-width: 480px) {
            ...
            .inventory-table-container::after {
        ...
        <div class="inventory-table-container">
            ...
            <tbody>
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    // Papar stok size jika ada dalam stok_produk.json
                    $stok_size_str = '-';
                    if (isset($stok_produk[$row['item_name']])) {
                        $arr = [];
                        foreach ($stok_produk[$row['item_name']] as $size => $stok) {
                            $arr[] = $size . ': ' . $stok;
                        }
                        $stok_size_str = implode(', ', $arr);
                    }
                    ?>
                    <tr>
                        <td><?php echo $bil++; ?></td>
